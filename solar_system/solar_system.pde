...
void setup()
{
  ...
  bolletjes.add(new Bolletje("jupiter", 60.0, 200.0, new PVector(size/2 + 250, size/2 + 250), new PVector(10,-10), color(250,150,100), sun));
  ...
  bolletjes.add(new Bolletje("pluto", 10.0, 200.0, new PVector(size/2 + 450, size/2 + 450), new PVector(10,-10), color(250,250,100), sun));
}
